...
sed -i "s/OpenWrt /YYYQQQ build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings
...
[ -z $(grep "CONFIG_KERNEL_BUILD_USER=" .config) ] &&
    ...
    sed -i 's@\(CONFIG_KERNEL_BUILD_USER=\).*@\1$"YYYQQQ"@' .config
